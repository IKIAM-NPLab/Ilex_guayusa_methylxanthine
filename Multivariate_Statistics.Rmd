...
set.seed(2500)
# Logarithmic scale
hm_scl <- log10(peak_height)
rownames(hm_scl) <- imputed@featureData@data$Metabolite
colnames(hm_scl) <- pheno_data$Level
...
#                            show_legend=F)
# Species color
cols_species <- c("Light conditions" = "#e6550d",
                 "Period age" = "#91cf60",
                 "Location" = "#33d2ff",
                 "Sample" = "#FFA319FF")
# Add top anotation to HeatMap
top_info_ann <- HeatmapAnnotation(`Factor` = pheno_data$Level,
                                  col = list(`Factor` = cols_species),
                                  show_annotation_name = T,
                                  show_legend=F, 
                                  border = TRUE)
# Color scale
